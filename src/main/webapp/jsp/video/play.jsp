...
<body>
    ...
    <div class="container">
        ...
        <div class="player">
            <video preload="auto" src="file/video/videos/${detail.fileName}" controls poster height="450px" style="float: left;max-width: 800px;">
            </video>
            <div class="episode">
                <h3 class="">视频选集</h3>
                <div class="line"></div>
                <div style="height: 400px;overflow: auto">
                    <c:forEach var="episode" items="${episodes}">
                        ...
                        <c:if test="${episode.id != detail.id}">
                            <a href="video/play?id=${episode.id}" style="display: block;" class="episodeFont">p${episode.episode}&nbsp;&nbsp; ${episode.title}</a>
                        </c:if>
                    </c:forEach>
                </div>
            </div>
